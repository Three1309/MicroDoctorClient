...
public class ClickShareInfoDiscussAdapter extends BaseAdapter {
    ...
    //初始化把上下文，数据列表传递过来
    public ClickShareInfoDiscussAdapter(Context context, List<ShareDiscussDto> list) {
...
//        collectAmount = list.get(position).getCollectAmount();
                        ...
                        OkHttpUtils.post(APPConfig.deleteShareDiscuss, new OkHttpUtils.ResultCallback() {
                            ...
                            public void onSuccess(Object response) {
                                if (response.toString().equals("deleteShareDiscuss_success")) {
                                    ClickShareInfoActivity.updateDiscussAmount();
        ...
        holder.name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("where", "ClickShareDiscussListView");
