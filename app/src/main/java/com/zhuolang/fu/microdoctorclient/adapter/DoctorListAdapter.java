...
public class DoctorListAdapter extends BaseAdapter{
    ...
    //初始化把上下文，数据列表传递过来
    public DoctorListAdapter(Context context, List<UserInfo> list) {
...
//        if (convertView == null) {
        ...
        holder.tv_number = (TextView) convertView.findViewById(R.id.tv_doctoritem_number);
        holder.tv_name = (TextView) convertView.findViewById(R.id.tv_doctoritem_name);
        holder.tv_hospital = (TextView) convertView.findViewById(R.id.tv_doctoritem_hospital);
        holder.tv_office = (TextView) convertView.findViewById(R.id.tv_doctoritem_office);
        holder.tv_amount = (TextView) convertView.findViewById(R.id.tv_doctoritem_amount);
        holder.tv_likenum = (TextView) convertView.findViewById(R.id.tv_doctoritem_likenum);
