...
import com.zhuolang.fu.microdoctorclient.Constant;
...
public class ChatToDoctorActivity extends Activity {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        findViewById(R.id.chatactivity_img_back).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        });
//        findViewById(R.id.chatactivity_tv_beizhu).setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(ChatActivity.this, AddFriendBeizuActivity.class);
//                startActivity(intent);
//            }
//        });
        toChatUsername = this.getIntent().getStringExtra("username");
        String username1=this.getIntent().getStringExtra("username1");
        TextView tv_toUsername = (TextView) this.findViewById(R.id.tv_toUsername);
        tv_toUsername.setText(username1);
        listView = (ListView) this.findViewById(R.id.listView);
        btn_send = (Button) this.findViewById(R.id.btn_send);
        et_content = (EditText) this.findViewById(R.id.et_content);
        getAllMessage();
        msgList = conversation.getAllMessages();
        adapter = new MessageAdapter(msgList, ChatToDoctorActivity.this);
    ...
    private String getUserName(String phone){
        ...
        OkHttpUtils.post(APPConfig.findUserByPhone, new OkHttpUtils.ResultCallback() {
            ...
            public void onSuccess(Object response) {
                ...
                SharedPrefsUtil.putValue(ChatToDoctorActivity.this,APPConfig.USERDATA, userData);
...
//                        CustomWaitDialog.miss();
                Toast.makeText(ChatToDoctorActivity.this, "服务器连接失败，请重试！", Toast.LENGTH_SHORT).show();
            }
        }, list);
        return userName[0];
    }
