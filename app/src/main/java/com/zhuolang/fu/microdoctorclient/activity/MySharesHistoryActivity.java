...
public class MySharesHistoryActivity extends Activity implements AdapterView.OnItemClickListener,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myshareshitory);

        getIntentUserId = getIntent().getStringExtra("userId");
//        whereStr = getIntent().getStringExtra("where");

        userDataStr = SharedPrefsUtil.getValue(MySharesHistoryActivity.this, APPConfig.USERDATA, "");
...
//        Toast.makeText(UserShareHouseInfoActivity.this, "dfddd", Toast.LENGTH_SHORT).show();
        ...
        listP.add(idParam);
        CustomWaitDialog.show(MySharesHistoryActivity.this,"获取数据。。。");
            ...
            public void run() {
                ...
                OkHttpUtils.post(APPConfig.findMyShareInfoHistory, new OkHttpUtils.ResultCallback() {
                    ...
                    public void onFailure(Exception e) {
                        ...
                        Toast.makeText(MySharesHistoryActivity.this, "服务器连接失败，请重试！", Toast.LENGTH_SHORT).show();
                    }
                },listP);
            }
        }).start();
