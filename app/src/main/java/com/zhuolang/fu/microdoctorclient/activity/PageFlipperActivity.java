...
//		viewFlipper = (ViewFlipper) this.findViewById(R.id.myViewFlipper);
	...
	private void createLeftFloatView(){
		...
		leftbtn.setImageResource(R.drawable.a1);
		leftbtn.setAlpha(200);
...
//				viewFlipper.showPrevious();
				Intent intent = new Intent(PageFlipperActivity.this,LoginActivity.class);
...
//            finish();
	...
	private void createRightFloatView(){
		...
		rightbtn.setImageResource(R.drawable.a2);
		rightbtn.setAlpha(0);
